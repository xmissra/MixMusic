...
?>
<tr class="hover">
<td class="width-50"><?php echo $row['in_adminid']; ?></td>
...
?>
<div class="container">
<script type="text/javascript">parent.document.title = 'MixMusic 管理中心 - 系统 - <?php echo $arrname; ?>用户';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='系统&nbsp;&raquo;&nbsp;<?php echo $arrname; ?>用户';</script>
<div class="floattop">
<div class="itemtitle">
<ul class="tab1">
...
<?php if(ergodic_array($in_permission,3)){echo "<li class=\"checked\">";}else{echo "<li>";} ?><input class="checkbox" type="checkbox" name="in_permission[]" id="value3" value="3"<?php if(ergodic_array($in_permission,3)){echo " checked";} ?>><label for="value3">风格</label></li>
<?php if(ergodic_array($in_permission,4)){echo "<li class=\"checked\">";}else{echo "<li>";} ?><input class="checkbox" type="checkbox" name="in_permission[]" id="value4" value="4"<?php if(ergodic_array($in_permission,4)){echo " checked";} ?>><label for="value4">内容</label></li>
<?php if(ergodic_array($in_permission,5)){echo "<li class=\"checked\">";}else{echo "<li>";} ?><input class="checkbox" type="checkbox" name="in_permission[]" id="value5" value="5"<?php if(ergodic_array($in_permission,5)){echo " checked";} ?>><label for="value5">用户</label></li>
...
<?php if(ergodic_array($in_permission,8)){echo "<li class=\"checked\">";}else{echo "<li>";} ?><input class="checkbox" type="checkbox" name="in_permission[]" id="value8" value="8"<?php if(ergodic_array($in_permission,8)){echo " checked";} ?>><label for="value8">扩展</label></li>
