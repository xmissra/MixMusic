...
?>
<div class="container">
<script type="text/javascript">parent.document.title = 'MixMusic 管理中心 - 用户 - 所有日志';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='用户&nbsp;&raquo;&nbsp;所有日志';</script>
<div class="floattop"><div class="itemtitle"><h3>所有日志</h3></div></div>
<table class="tb tb2">
