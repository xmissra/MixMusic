...
?>
<div class="container">
<script type="text/javascript">parent.document.title = 'MixMusic 管理中心 - 用户 - 所有留言';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='用户&nbsp;&raquo;&nbsp;所有留言';</script>
<div class="floattop"><div class="itemtitle"><h3>所有留言</h3></div></div>
<table class="tb tb2">
