...
<body>
<div class="container">
<script type="text/javascript">parent.document.title = 'MixMusic 管理中心 - 安装应用';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='安装应用';</script>
<div class="floattop"><div class="itemtitle"><h3>安装应用</h3></div></div>
<table class="tb tb2">
