...
$(function() {
 ...
 $(function() {
	...
	$("#tool_channel_active").live("click",
	function() {
...
function ssplay() {
	...
	case 6:
		...
		break;
	case 3:
		if (parseInt(jiuku.controls.currentPosition) > 1) {
			stnumk = 0;
		}
		$(".jp-play").hide();
		$(".jp-pause").show();
...
function btnunmute() {
	try {
		...
		document.getElementById('mediaPlayerObj').settings.volume = d + 20;
		$('.jp-volume-bar-value').css('width', d + 'px');
		$('.jp-unmute').hide();
		$('.jp-mute').show();
	} catch(e) {
