!function(a, b) {
        ...
        var c = [], d = c.slice, e = c.concat, f = c.push, g = c.indexOf, h = {}, i = h.toString, j = h.hasOwnProperty, k = {}, l = a.document, m = "2.1.1-rc2", n = function(a, b) {
        ...
        function Vb(a, b, c) {
                ...
                j = n.css(a, "display"), "inline" === ("none" === j ? tb(a.nodeName) :j) && "none" === n.css(a, "float") && (m.display = "inline-block")), 
                ...
                if (n.isEmptyObject(l)) "inline" === ("none" === j ? tb(a.nodeName) :j) && (m.display = j); else {
                        p ? "hidden" in p && (o = p.hidden) :p = L.access(a, "fxshow", {}), f && (p.hidden = !o), 
                        o ? n(a).show() :k.done(function() {
                                n(a).hide();
                        }), k.done(function() {
                                var b;
                                L.remove(a, "fxshow");
                        ...
                        for (d in l) g = Ub(o ? p[d] :0, d, k), d in p || (p[d] = g.start, o && (g.end = g.start, 
